...
void DoubleKittyKick::displayHitDescription(Entity* hitter, Entity* hittee, int dmg) {
	std::cout << hitter->getName() << " used its foots to kick " << hittee->getName() << " right in the mouf.\n";
